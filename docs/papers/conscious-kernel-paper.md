...
- Control continuo **resuelto** en Pendulum (§3.13, greedy −181) con un actor
  tanh-Gaussian; validado en una tarea continua simple. Falta **DMC propio
  (MuJoCo)** y entornos continuos más ricos / de mayor dimensión.
