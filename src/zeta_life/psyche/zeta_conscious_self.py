...
from .zeta_dream_consolidation import (
    ConsolidationReport,
    DreamConsolidator,
    HebbianLearner,
    OnlineLearner,
...
# =============================================================================
# INTEGRATION FEEDBACK (moved from zeta_integration_feedback.py)
# =============================================================================
...
class IntegrationFeedback:
    ...
    def _modify_psyche_parameters(self, psyche: ZetaPsyche, metrics: IntegrationMetrics, stage: IndividuationStage) -> None:
        cooperation = self.STAGE_COOPERATION[stage]
