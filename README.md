...
[![Tests](https://img.shields.io/badge/tests-491%20passed-brightgreen.svg)](tests/)
...
```bash
PYTHONPATH=src pytest tests/ -q   # 491 tests (or `pip install -e .` first)
```
...
|
|-- experiments/
|   |-- kernel/          # 19 kernel experiments (the live research)
