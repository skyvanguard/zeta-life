...
[![Tests](https://img.shields.io/badge/tests-496%20passed-brightgreen.svg)](tests/)
...
```bash
PYTHONPATH=src pytest tests/ -q   # 496 tests (or `pip install -e .` first)
```
